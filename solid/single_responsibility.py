...
animal database management and animal properties management. 
...
To make this conform to SRP, we create another class that will handle the sole responsibility of storing 
